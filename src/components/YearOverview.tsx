...
import { STRINGS, monthNames, MONTHS_SHORT, type Locale } from '@/constants/i18n';
...
const YearOverview: React.FC<YearOverviewProps> = ({
  ...
  const monthShort = MONTHS_SHORT[locale as Locale];
